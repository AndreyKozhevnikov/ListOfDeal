...
namespace ConsoleApp1.ListOfDealBase {
    ...
    public partial class Actions : XPLiteObject {
        ...
        public Projects ProjectId {
            ...
            set { SetPropertyValue<Projects>(nameof(ProjectId), ref fProjectId, value); }
        }
        ...
        public XPCollection<WeekRecords> WeekRecordsCollection { get { return GetCollection<WeekRecords>(nameof(WeekRecordsCollection)); } }
    }
