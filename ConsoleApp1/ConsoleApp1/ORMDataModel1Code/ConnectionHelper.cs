...
namespace ConsoleApp1.ListOfDealBase {
    public static class ConnectionHelperLoc {
     ...
     public   static IDataLayer MyDataLayer;
        public static Type[] GetPersistentTypes() {
            Type[] copy = new Type[persistentTypes.Length];
            Array.Copy(persistentTypes, copy, persistentTypes.Length);
            return copy;
        }
        public static string ConnectionString { get { return System.Configuration.ConfigurationManager.ConnectionStrings["KOZHEVNIKOV-NBXListOfDealBase"].ConnectionString; } }
        public static void Connect(DevExpress.Xpo.DB.AutoCreateOption autoCreateOption, bool threadSafe = false) {
            if (threadSafe) {
             ...
             //  XpoDefault.DataLayer = new ThreadSafeDataLayer(dictionary, provider);
                ...
                MyDataLayer = XpoDefault.GetDataLayer(ConnectionString, autoCreateOption);
            }
