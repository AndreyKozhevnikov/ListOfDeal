...
namespace ConsoleApp1.ListOfDealBase {
    ...
    public partial class ProjectTypes : XPLiteObject {
        int fId;
        [Key(true)]
        public int Id {
            get { return fId; }
        ...
        public XPCollection<Projects> ProjectsCollection { get { return GetCollection<Projects>(nameof(ProjectsCollection)); } }
    }
