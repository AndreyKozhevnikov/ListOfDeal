...
namespace ConsoleApp1.ListOfDealBase {
    ...
    public partial class Projects : XPLiteObject {
        ...
        ProjectTypes fTypeId;
        [Association(@"ProjectsReferencesProjectTypes")]
        public ProjectTypes TypeId {
            get { return fTypeId; }
            set { SetPropertyValue<ProjectTypes>(nameof(TypeId), ref fTypeId, value); }
        }
        ...
        public XPCollection<Actions> ActionsCollection { get { return GetCollection<Actions>(nameof(ActionsCollection)); } }
    }
